...
public:
	...
	inline void getRandomMatrix3x3(double min, double max, double** m);
...
inline void tum::RandomGenerator::getRandomMatrix3x3(double min, double max, double** m)
{
	m[0][0] = this->getRandomNumberInInterval(min, max); m[0][1] = this->getRandomNumberInInterval(min, max); m[0][2] = this->getRandomNumberInInterval(min, max);
	m[1][0] = this->getRandomNumberInInterval(min, max); m[1][1] = this->getRandomNumberInInterval(min, max); m[1][2] = this->getRandomNumberInInterval(min, max);
	m[2][0] = this->getRandomNumberInInterval(min, max); m[2][1] = this->getRandomNumberInInterval(min, max); m[2][2] = this->getRandomNumberInInterval(min, max);
}
