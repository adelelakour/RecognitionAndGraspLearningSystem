...
{
public:
	inline ORRPointSetShape(UserData* userdata, vtkPolyData* polydata, const double* rigid_transform, int instanceNumber);
...
inline ORRPointSetShape::ORRPointSetShape(UserData* userdata, vtkPolyData* polydata, const double* rigid_transform, int instanceNumber)
: PointSetShape(userdata, polydata, rigid_transform)
{
