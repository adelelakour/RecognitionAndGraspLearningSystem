...
{
public:
	GeometryProcessor():mcv(3, 3, CV_64FC1), qcv(3, 3, CV_64FC1){}
	...
	inline void cvPolarDecomp(const double M[3][3], double* R);
...
inline void GeometryProcessor::cvPolarDecomp(const double M[3][3], double* R)
{
